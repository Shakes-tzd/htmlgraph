...
def main():
    ...
    track = sdk.tracks.create('Delegation Test Track') \
    ...
    # Feature 1: 3 steps
    print("\nCreating Feature 1...")
    feature1 = sdk.features.create('Delegation Test Feature 1') \
        .set_priority('high') \
    ...
    # Feature 2: 4 steps
    print("\nCreating Feature 2...")
    feature2 = sdk.features.create('Delegation Test Feature 2') \
        .set_priority('medium') \
        .set_status('in-progress') \
        .add_steps([
    ...
    # Feature 3: 2 steps
    print("\nCreating Feature 3...")
    feature3 = sdk.features.create('Delegation Test Feature 3') \
        .set_priority('low') \
        .set_status('in-progress') \
        .add_steps([
            'Document delegation patterns',
            'Create delegation test suite'
        ]) \
        .set_track(track.id) \
    ...
    spike = sdk.spikes.create('Delegation Test Run 2') \
        .set_findings(f"""
