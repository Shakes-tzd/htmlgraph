...
func (s *SDK) FindBottlenecks() ([]Bottleneck, error) {
	nodes, err := loadAllNodes(s.ProjectDir)
	if err != nil {
...
func (s *SDK) RecommendNextWork() ([]Recommendation, error) {
	nodes, err := loadAllNodes(s.ProjectDir)
	if err != nil {
...
func (s *SDK) GetParallelWork() ([]ParallelSet, error) {
	nodes, err := loadAllNodes(s.ProjectDir)
	if err != nil {
