...
class TestBaseBuilderTrackIdValidation:
    ...
    def test_feature_without_track_raises_error(self, tmp_htmlgraph: Path):
    ...
    def test_feature_with_track_saves_successfully(self, tmp_htmlgraph: Path):
    ...
    def test_feature_track_linkage_persists(self, tmp_htmlgraph: Path):
    ...
    def test_error_message_includes_available_tracks(self, tmp_htmlgraph: Path):
    ...
    def test_error_message_fallback_when_no_tracks(self, tmp_htmlgraph: Path):
    ...
    def test_feature_with_track_and_priority(self, tmp_htmlgraph: Path):
    ...
    def test_feature_with_track_and_steps(self, tmp_htmlgraph: Path):
    ...
    def test_feature_with_track_and_description(self, tmp_htmlgraph: Path):
    ...
    def test_feature_multiple_relationships_with_track(self, tmp_htmlgraph: Path):
    ...
    def test_feature_in_different_collections(self, tmp_htmlgraph: Path):
...
class TestSetTrackMethod:
    ...
    def test_set_track_returns_builder(self, tmp_htmlgraph: Path):
    ...
    def test_set_track_multiple_times(self, tmp_htmlgraph: Path):
    ...
    def test_set_track_with_empty_string_fails(self, tmp_htmlgraph: Path):
...
class TestFeatureCreateFluentAPI:
    ...
    def test_fluent_api_with_all_options(self, tmp_htmlgraph: Path):
    ...
    def test_fluent_api_preserves_agent_attribution(self, tmp_htmlgraph: Path):
...
class TestTrackValidationEdgeCases:
    ...
    def test_feature_with_none_track_id(self, tmp_htmlgraph: Path):
    ...
    def test_feature_with_invalid_track_id(self, tmp_htmlgraph: Path):
    ...
    def test_feature_track_id_special_characters(self, tmp_htmlgraph: Path):
...
class TestFeatureCreateErrorMessages:
    ...
    def test_error_message_includes_feature_title(self, tmp_htmlgraph: Path):
    ...
    def test_error_message_is_clear_and_actionable(self, tmp_htmlgraph: Path):
...
class TestCollectionSpecificTrackRequirement:
    ...
    def test_only_features_collection_requires_track(self, tmp_htmlgraph: Path):
