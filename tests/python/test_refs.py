...
class TestRefManager:
    ...
    def test_ref_generation(self, ref_manager):
    ...
    def test_ref_resolution(self, ref_manager):
    ...
    def test_ref_persistence(self, ref_manager, temp_graph_dir):
    ...
    def test_ref_idempotency(self, ref_manager):
    ...
    def test_get_refs_by_type(self, ref_manager):
    ...
    def test_rebuild_refs(self, ref_manager, temp_graph_dir):
    ...
    def test_rebuild_refs_preserves_existing(self, ref_manager, temp_graph_dir):
    ...
    def test_invalid_node_id(self, ref_manager):
    ...
    def test_corrupted_refs_file(self, temp_graph_dir):
...
class TestSDKIntegration:
    ...
    def test_sdk_initializes_ref_manager(self, temp_graph_dir):
        """Test that SDK initializes RefManager."""
        sdk = SDK(agent="test-agent", directory=temp_graph_dir)
        assert hasattr(sdk, "refs")
        assert isinstance(sdk.refs, RefManager)

    def test_sdk_ref_method(self, temp_graph_dir):
    ...
    def test_sdk_ref_method_multiple_types(self, temp_graph_dir):
    ...
    def test_sdk_ref_nonexistent(self, temp_graph_dir):
    ...
    def test_collection_get_ref(self, temp_graph_dir):
    ...
    def test_ref_persistence_across_sdk_instances(self, temp_graph_dir):
    ...
    def test_ref_manager_set_on_all_collections(self, temp_graph_dir):
    ...
    def test_ref_generation_on_create(self, temp_graph_dir):
