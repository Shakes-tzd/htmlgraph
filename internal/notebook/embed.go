...
//
//go:embed files/plan_notebook.py files/plan_ui.py files/plan_persistence.py files/critique_renderer.py files/dagre_widget.py files/chat_widget.py files/claude_chat.py
var Files embed.FS
