...
class SDKSettings(BaseSettings):
    ...
    def get_htmlgraph_dir(self) -> Path:
        ...
        return Path(self.project_root) / self.htmlgraph_dir_name

    def get_collection_dir(self, collection: str) -> Path:
        """
    ...
    def get_database_path(self) -> Path:
        ...
        return Path(self.get_htmlgraph_dir()) / self.database_filename

    def get_analytics_cache_path(self) -> Path:
        """Get the analytics cache database path."""
        return Path(self.get_htmlgraph_dir()) / self.analytics_cache_filename
...
# pydantic-settings is now a hard dependency; this constant exists for
# backward compatibility with tests that imported it during the transition.
